<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="contact.aspx.vb" Inherits="cloudPOS.contact" %>
...
<head id="Head1" runat="server">
    ...
    <title>cloudPOS - Contact Us</title>
        ...
        <form id="Form1" runat="server">
            <div class="header">
                <ul class="nav nav-pills pull-right">
                    ...
                    <li class="active"><a id="A2" href="contact.aspx" runat="server">Contact Us</a></li>
