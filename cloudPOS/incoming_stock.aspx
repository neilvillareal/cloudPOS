<%@ Page Language="vb" MasterPageFile="~/Dashboard.Master" AutoEventWireup="false" CodeBehind="incoming_stock.aspx.vb" Inherits="cloudPOS.incoming_stock" %>
...
<asp:Content runat="server" ID="DashContent" ContentPlaceHolderID="DashContent">
    ...
    <div class="col-md-8">
        <div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title">Incoming Stocks</h1>
			</div>
    ...
    <div class="col-md-4">
        <div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title">Add Incoming Stock</h1>
			</div>
			<div class="panel-body">                
                ...
                <asp:DropDownList ID="cboSupplier" runat="server" Cssclass="col-md-12 form-control" >
                </asp:DropDownList>
                <br />
                <asp:Label ID="Label4" runat="server" Text="Date of Purchase"></asp:Label>
                <asp:Calendar ID="cdOrd" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px">
                ...
                <br />
                <asp:Label ID="Label2" runat="server" Text="Arrival Date"></asp:Label>
                <asp:Calendar ID="cdArr" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px">
                    <DayHeaderStyle BackColor="#CCCCCC" Font-Bold="True" Font-Size="7pt" />
                    <NextPrevStyle VerticalAlign="Bottom" />
                    <OtherMonthDayStyle ForeColor="#808080" />
                    <SelectedDayStyle BackColor="#666666" Font-Bold="True" ForeColor="White" />
